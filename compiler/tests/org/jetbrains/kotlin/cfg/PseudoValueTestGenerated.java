...
public class PseudoValueTestGenerated extends AbstractPseudoValueTest {
    ...
    public static class Cfg_variables extends AbstractPseudoValueTest {
        ...
        public static class Effects extends AbstractPseudoValueTest {
            ...
            @TestDataPath("$PROJECT_ROOT")
            @RunWith(JUnit3RunnerWithInners.class)
            public static class Controlflow extends AbstractPseudoValueTest {
                ...
                @TestDataPath("$PROJECT_ROOT")
                @RunWith(JUnit3RunnerWithInners.class)
                public static class FlowInlining extends AbstractPseudoValueTest {
                ...
                @TestDataPath("$PROJECT_ROOT")
                @RunWith(JUnit3RunnerWithInners.class)
                public static class Initialization extends AbstractPseudoValueTest {
                    ...
                    @TestDataPath("$PROJECT_ROOT")
                    @RunWith(JUnit3RunnerWithInners.class)
                    public static class AtLeastOnce extends AbstractPseudoValueTest {
                    ...
                    @TestDataPath("$PROJECT_ROOT")
                    @RunWith(JUnit3RunnerWithInners.class)
                    public static class ExactlyOnce extends AbstractPseudoValueTest {
                    ...
                    @TestDataPath("$PROJECT_ROOT")
                    @RunWith(JUnit3RunnerWithInners.class)
                    public static class Unknown extends AbstractPseudoValueTest {
